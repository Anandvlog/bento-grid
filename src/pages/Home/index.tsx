  ...
  return (
    <div className="container">
      ...
      <div className="multi-media-card">
        <img alt="social-media" src="/assets/images/illustration-multiple-platforms.webp"  />
        <h2>Manage multiple accounts and platforms.</h2>
      </div>

      <div className="maintain-card">
          <h2>Maintain a consistent posting schedule.</h2>
          <img src="/assets/images/illustration-consistent-schedule.webp" alt="Maintain Schedule" />
      </div>

        <div className="audience-card">
          <h2>{">"}56%</h2>
          <p>faster audience growth</p>
          <img alt="audience growth" src="/assets/images/illustration-audience-growth.webp" />
        </div>

        <div className="followers-card">
              <img alt="followers" src="/assets/images/illustration-grow-followers.webp" />
